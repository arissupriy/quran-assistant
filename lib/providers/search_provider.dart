...
import 'package:quran_assistant/core/models/chapter_model.dart'; // Import Chapter model untuk chapter details
...
class SearchNotifier extends StateNotifier<SearchState> {
  ...
  Future<void> performSearch(String newQuery) async {
    ...
    state = state.copyWith(query: newQuery, isLoading: true, errorMessage: null);
    ...
    try {
      ...
      for (final searchType in SearchType.values) {
        final currentTypeResults = await _rustService.searchAyahsByWordForm(
          newQuery,
          searchType,
        );
