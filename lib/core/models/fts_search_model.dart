...
import 'package:flutter/foundation.dart'; // Diperlukan untuk @required atau @immutable (jika dipakai)
...
class FtsSearchResult {
  ...
  factory FtsSearchResult.fromJson(Map<String, dynamic> json) {
    return FtsSearchResult(
      ...
      score: (json['score'] as num).toDouble(), // num karena bisa int atau double dari JSON
      words: (json['words'] as List<dynamic>)
          .map((wordJson) => FtsWordResult.fromJson(wordJson as Map<String, dynamic>))
          .toList(),
