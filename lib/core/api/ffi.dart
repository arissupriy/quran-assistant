...
final InitEngineDart initEngine =
    _rustLib.lookupFunction<InitEngineNative, InitEngineDart>('init_engine');
...
final FreeStringDart freeString =
    _rustLib.lookupFunction<FreeStringNative, FreeStringDart>('free_string');
...
typedef FreeByteBufferNative = Void Function(Pointer<Uint8> dataPtr, Uint64 dataLen);
...
typedef GetVerseTextUthmaniNative = Pointer<Utf8> Function(Pointer<Utf8> verseKey);
typedef GetVerseTextUthmaniDart = Pointer<Utf8> Function(Pointer<Utf8> verseKey);
...
typedef GetJuzNumberForVerseNative = Pointer<Utf8> Function(Pointer<Utf8> verseKey);
typedef GetJuzNumberForVerseDart = Pointer<Utf8> Function(Pointer<Utf8> verseKey);
...
typedef GetVerseByChapterAndVerseNumberNative = Pointer<Utf8> Function(
    Uint32 chapterId, Uint32 verseNumber);
typedef GetVerseByChapterAndVerseNumberDart = Pointer<Utf8> Function(
    int chapterId, int verseNumber);
final GetVerseByChapterAndVerseNumberDart getVerseByChapterAndVerseNumber = _rustLib
    .lookupFunction<GetVerseByChapterAndVerseNumberNative,
        GetVerseByChapterAndVerseNumberDart>('get_verse_by_chapter_and_verse_number');

/// Mengembalikan teks terjemahan dalam JSON.
typedef GetTranslationTextNative = Pointer<Utf8> Function(
    Pointer<Utf8> verseKey, Uint32 resourceId);
typedef GetTranslationTextDart = Pointer<Utf8> Function(
    Pointer<Utf8> verseKey, int resourceId);
...
typedef GetWordDetailsNative = Pointer<Utf8> Function(
    Uint32 chapterId, Uint32 verseNumber, Uint32 wordPosition);
typedef GetWordDetailsDart = Pointer<Utf8> Function(
    int chapterId, int verseNumber, int wordPosition);
...
typedef GetPageLayoutByPageNumberNative = Pointer<Utf8> Function(Uint32 pageNumber);
...
final GetPageLayoutByPageNumberDart getPageLayoutByPageNumber = _rustLib
    .lookupFunction<GetPageLayoutByPageNumberNative, GetPageLayoutByPageNumberDart>(
        'get_page_layout_by_page_number');

/// Mengembalikan WordData untuk baris dalam JSON array.
typedef GetLineWordsNative = Pointer<Utf8> Function(Uint32 pageNumber, Uint32 lineIndex);
typedef GetLineWordsDart = Pointer<Utf8> Function(int pageNumber, int lineIndex);
final GetLineWordsDart getLineWords = _rustLib
    .lookupFunction<GetLineWordsNative, GetLineWordsDart>(
        'get_line_words');
...
final GetJuzDetailsDart getJuzDetails = _rustLib
    .lookupFunction<GetJuzDetailsNative, GetJuzDetailsDart>(
        'get_juz_details');

/// Mengembalikan metadata terjemahan (nama) dalam JSON string.
typedef GetTranslationMetadataByIdNative = Pointer<Utf8> Function(Uint32 resourceId);
...
final GetTranslationMetadataByIdDart getTranslationMetadataById = _rustLib
    .lookupFunction<GetTranslationMetadataByIdNative, GetTranslationMetadataByIdDart>(
        'get_translation_metadata_by_id');

// --- Index Query FFI ---

/// Mengembalikan kunci ayat untuk lemma dalam JSON array.
typedef GetAllVerseKeysForLemmaNative = Pointer<Utf8> Function(Pointer<Utf8> lemma);
typedef GetAllVerseKeysForLemmaDart = Pointer<Utf8> Function(Pointer<Utf8> lemma);
...
typedef SearchAyahsByWordFormNative = Pointer<Utf8> Function(
    Pointer<Utf8> query, Uint32 searchType);
typedef SearchAyahsByWordFormDart = Pointer<Utf8> Function(
    Pointer<Utf8> query, int searchType);
...
final SearchPhraseDart searchPhrase = _rustLib
    .lookupFunction<SearchPhraseNative, SearchPhraseDart>(
        'search_phrase');
...
typedef GenerateVerseCompletionQuizNative = Pointer<Utf8> Function(
    Pointer<Uint8> filterDataPtr, Uint64 filterLen);
typedef GenerateVerseCompletionQuizDart = Pointer<Utf8> Function(
    Pointer<Uint8> filterDataPtr, int filterLen);
final GenerateVerseCompletionQuizDart generateVerseCompletionQuiz = _rustLib
    .lookupFunction<GenerateVerseCompletionQuizNative, GenerateVerseCompletionQuizDart>(
        'generate_verse_completion_quiz');

/// Menghasilkan kuis Fragment Completion dalam JSON.
/// PERBAIKAN KRITIS: Sekarang menerima pointer ke data mentah (Pointer<Uint8>)
/// dan panjangnya (Uint64) secara terpisah.
typedef GenerateVerseFragmentQuizNative = Pointer<Utf8> Function(
    Pointer<Uint8> filterDataPtr, Uint64 filterLen);
typedef GenerateVerseFragmentQuizDart = Pointer<Utf8> Function(
    Pointer<Uint8> filterDataPtr, int filterLen);
final GenerateVerseFragmentQuizDart generateVerseFragmentQuiz = _rustLib
    .lookupFunction<GenerateVerseFragmentQuizNative, GenerateVerseFragmentQuizDart>(
        'generate_verse_fragment_quiz');

/// Menghasilkan kuis Verse Puzzle dalam JSON.
/// PERBAIKAN KRITIS: Sekarang menerima pointer ke data mentah (Pointer<Uint8>)
/// dan panjangnya (Uint64) secara terpisah.
typedef GenerateVersePuzzleQuizNative = Pointer<Utf8> Function(
    Pointer<Uint8> filterDataPtr, Uint64 filterLen);
typedef GenerateVersePuzzleQuizDart = Pointer<Utf8> Function(
    Pointer<Uint8> filterDataPtr, int filterLen);
...
/// PERBAIKAN KRITIS: Sekarang menerima pointer ke data mentah (Pointer<Uint8>)
/// dan panjangnya (Uint64) secara terpisah.
typedef GenerateWordPuzzleQuizNative = Pointer<Utf8> Function(
    Pointer<Uint8> filterDataPtr, Uint64 filterLen);
typedef GenerateWordPuzzleQuizDart = Pointer<Utf8> Function(
    Pointer<Uint8> filterDataPtr, int filterLen);
