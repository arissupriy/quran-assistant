...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -497067588;
...
10 => wire__crate__api__quran__chapter__get_chapter_details_impl(port, ptr, rust_vec_len, data_len),
...
19 => wire__crate__api__quran__similarity__get_similar_ayahs_inverted_impl(port, ptr, rust_vec_len, data_len),
20 => wire__crate__api__quran__verse__get_translation_text_impl(port, ptr, rust_vec_len, data_len),
21 => wire__crate__api__quran__verse__get_verse_by_chapter_and_verse_number_impl(port, ptr, rust_vec_len, data_len),
22 => wire__crate__api__quran__verse__get_verse_text_uthmani_impl(port, ptr, rust_vec_len, data_len),
23 => wire__crate__api__quran__verse__get_word_details_impl(port, ptr, rust_vec_len, data_len),
25 => wire__crate__api__simple__init_app_impl(port, ptr, rust_vec_len, data_len),
26 => wire__crate__api__engine_loader__load_engine_data_from_flutter_assets_impl(port, ptr, rust_vec_len, data_len),
27 => wire__crate__api__mushaf__open_mushaf_pack_impl(port, ptr, rust_vec_len, data_len),
28 => wire__crate__api__engine_loader__reset_engine_from_flutter_impl(port, ptr, rust_vec_len, data_len),
                        _ => unreachable!(),
                    }
}
